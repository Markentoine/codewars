...
# it's like you were suddenly hit by a beam of light and
# knew that it was your mission to combine the two to create a computerized Fizz Buzz cuckoo clock!
...
# Soon the only task remaining was
# to write a function to select from the sounds you had recorded depending on what time it was:
...
# On the half hour, instead of "Fizz Buzz",
# the clock door will open, and the cuckoo will come out and "Cuckoo" just once.
...
# Your return value will be a string
# containing the combination of Fizz, Buzz, Cuckoo,
# and/or tick sounds that the clock needs to make at that time,
# separated by spaces.

# Note that although the input is in 24-hour time,
# cuckoo clocks' cuckoos are in 12-hour time.
