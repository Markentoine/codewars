...
Router.prototype.bind = function(path, method, cb) {
    this.routes[method] ? this.routes[method][path] = cb : this.routes[method] = { path: cb};
}

Router.prototype.runRequest = function(path, method) {
    if (this.routes[method][path]) {
        return this.routes[method][path].call(null);
    } else {
